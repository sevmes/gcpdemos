...
func getDB() (*sql.DB, func() error) {
	...
	//dsn := fmt.Sprintf("host=%s user=%s password=%s dbname=%s sslmode=disable", "projects/qwiklabs-gcp-02-aa672ab958c7/locations/us-central1/clusters/devopsdemo-alloydb-cluster-1/instances/devopsdemo-alloydb-instance-1", "postgres","password", os.Getenv("DB_NAME"))
